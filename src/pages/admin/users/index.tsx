  ...
  const renderItem = (item: any) => {
    ...
    return (
      <List.Item>
        <List.Item.Meta
          className={
            '!border !border-[color:var(--@very-light-gray)] p-[10px] !h-[140px] sm:!h-[140px] md:!h-[160px] lg:!h-[160px] xl:!h-[160px]'
          }
          title={
          ...
          description={
            <>
              ...
              <div
                className={
                  'text-[color:var(--text-color)] font-normal text-[13px] sm:text-[14px] md:text-[16px] lg-[16px] xl:text-[16px] capitalize'
                }
              >
                Role:{' '}
              ...
              <div
                className={
                  'text-[color:var(--primary-color)]  font-light text-[12px] sm:text-[13px] md:text-[13px] lg-[13px] xl:text-[13px] italic'
                }
              >
