...
export enum ENUM_STATUS_WEBSITE {
  UN_VERIFY = 1,
  VERIFY = 2,
  FAILD = 3,
}

export enum ENUM_MATCH_WEBSITE {
  UN_VERIFY = 1,
  MATCHED = 2,
  MISMATCHED = 3,
}
...
export const OPTION_STRING_BOOLEAN = [
  { label: 'True', value: 'true' },
  { label: 'False', value: 'false' },
]

export const STATUS_WEBSITE = [
  { label: 'Un Verified', value: 1 },
  { label: 'Verified', value: 2 },
  { label: 'Faild', value: 3 },
]

export const MATCH_WEBSITE = [
  { label: 'Un Verified', value: 1 },
  { label: 'Matched', value: 2 },
  { label: 'Mismatched', value: 3 },
]

export const OPTION_VERIFY = [
...
export const MIN_NUMBER_PATTERN = /^[1-9]\d*$/
...
export const THUMBNAIL_DETAIL =
  'https://i4.ypcdn.com/ypu/images/default-thumbnails/thumbnail-1.svg'

//
export const ICON_LINK: any = {
  instagram: 'https://ssl.gstatic.com/kpui/social/instagram_32x32.png',
  facebook: 'https://ssl.gstatic.com/kpui/social/fb_32x32.png',
